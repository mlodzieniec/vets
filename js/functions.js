...
! function($) {
    ...
    SEMICOLON.initialize = {
        init: function() {
            SEMICOLON.initialize.responsiveClasses(), SEMICOLON.initialize.stickyElements(), SEMICOLON.initialize.goToTop(), SEMICOLON.initialize.lazyLoad(), SEMICOLON.initialize.fullScreen(), SEMICOLON.initialize.verticalMiddle(), SEMICOLON.initialize.lightbox(), SEMICOLON.initialize.resizeVideos(), SEMICOLON.initialize.imageFade(), SEMICOLON.initialize.dataResponsiveClasses(), SEMICOLON.initialize.dataResponsiveHeights(), SEMICOLON.initialize.stickFooterOnSmall(), SEMICOLON.initialize.stickyFooter(), $(".fslider").addClass("preloader2")
        },
...
//            if (t || (t = 300), "true" != e && ($body.hasClass("device-sm") || $body.hasClass("device-xs"))) return !0;
            $window.scrollTop() > 300 ? ($goToTopEl.fadeIn(), $body.addClass("gototop-active")) : ($goToTopEl.fadeOut(), $body.removeClass("gototop-active"))
        },
        fullScreen: function() {
        ...
        menufunctions: function() {
            $("#primary-menu ul li:has(ul)").addClass("sub-menu"), $(".top-links ul li:has(ul) > a, #primary-menu.with-arrows > ul > li:has(ul) > a > div, #primary-menu.with-arrows > div > ul > li:has(ul) > a > div, #page-menu nav ul li:has(ul) > a > div").append('<i class="fas fa-arrow-down"></i>'), $(".top-links > ul").addClass("clearfix"), ($body.hasClass("device-xl") || $body.hasClass("device-lg")) && ($("#primary-menu.sub-title > ul > li").hover(function() {
                $(this).prev().css({
        ...
        parallax: function() {
            ...
            ($parallaxEl.length > 0 || $parallaxPageTitleEl.length > 0 || $(".portfolio-parallax").find(".portfolio-image").length > 0) && (SEMICOLON.isMobile.any() ? ($parallaxEl.addClass("mobile-parallax"), $parallaxPageTitleEl.addClass("mobile-parallax"), $(".portfolio-parallax").find(".portfolio-image").addClass("mobile-parallax")) : skrollr.init({
                forceHeight: !1
            }))
        },
        animations: function() {
            ...
            e.length > 0 && e.each(function() {
                ...
                t || (t = "slide"), a && "swing" != a || (a = "swing", m = !0), i || (i = "horizontal"), s = "true" == s, o = !o, n || (n = 5e3), r || (r = 600), l || (l = !1), h = "false" != h, "vertical" == i && (h = !1), d = "false" != d, d = "true" == u ? "thumbnails" : d, c = "false" != c, f = "false" != f, p = "false" != p, e.flexslider({
                    ...
                    start: function(e) {
                        ...
                        SEMICOLON.initialize.lightbox(), $(".flex-prev").html('<i class="fas fa-arrow-left"></i>'), $(".flex-next").html('<i class="fas fa-arrow-right"></i>'), SEMICOLON.portfolio.portfolioDescMargin()
                    },
                    after: function() {
        ...
        navTree: function() {
            ...
            e.length > 0 && e.each(function() {
                ...
                t || (t = 250), a || (a = "swing"), e.find("ul li:has(ul)").addClass("sub-menu"), e.find("ul li:has(ul) > a").append(' <i class="fas fa-arrow-down"></i>'), e.hasClass("on-hover") ? e.find("ul li:has(ul):not(.active)").hover(function(e) {
        ...
        init: function() {
            setTimeout(function() {
                SEMICOLON.header.topsocial(), SEMICOLON.header.fullWidthMenu(), SEMICOLON.header.overlayMenu(), SEMICOLON.initialize.fullScreen(), SEMICOLON.initialize.dataResponsiveHeights(), SEMICOLON.initialize.verticalMiddle(), SEMICOLON.initialize.testimonialsGrid(), SEMICOLON.initialize.stickFooterOnSmall(), SEMICOLON.initialize.stickyFooter(), SEMICOLON.slider.sliderParallaxDimensions(), SEMICOLON.slider.captionPosition(), SEMICOLON.portfolio.arrange(), SEMICOLON.portfolio.portfolioDescMargin(), SEMICOLON.widget.tabsResponsiveResize(), SEMICOLON.widget.tabsJustify(), SEMICOLON.widget.html5Video(), SEMICOLON.widget.masonryThumbs(), SEMICOLON.initialize.dataResponsiveClasses(), $(".grid-container").length > 0 && ($(".grid-container").hasClass(".customjs") || ($().isotope ? $(".grid-container").isotope("layout") : console.log("documentOnResize > init: Isotope not defined."))), ($body.hasClass("device-xl") || $body.hasClass("device-lg")) && $("#primary-menu").find("ul.mobile-primary-menu").removeClass("d-block")
            }, 500);
    ...
    }(window, document, 0, 0, "ga"), ga("create", "UA-23255544-12", "auto"), ga("send", "pageview");